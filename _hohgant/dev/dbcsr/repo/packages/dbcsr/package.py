...
class Dbcsr(CMakePackage, CudaPackage, ROCmPackage):
    ...
    # Optimised A100 parameters only for @2.5.0:
    dbcsr_cuda_archs = ["35", "37", "60", "70", conditional("80", when="@2.3.0:")]
    cuda_msg = "dbcsr only supports cuda_arch {0}".format(dbcsr_cuda_archs)
    print(dbcsr_cuda_archs)
    ...
    dbcsr_amdgpu_targets = [
        "gfx906",
        conditional("gfx908", when="@2.1.0:"),
        conditional("gfx90a", when="@2.3.0:"),
    ]
    print(dbcsr_amdgpu_targets)
